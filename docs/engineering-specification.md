...
| SET-01 | Estimate isolated spherical-particle settling in the creeping-flow regime.            | Stokes drag/terminal balance candidate.                                                      | G. G. Stokes, [“On the effect of the internal friction of fluids on the motion of pendulums” (1851)](https://doi.org/10.1017/CBO9780511702266.002)                                                                                                                      | Newtonian continuum, isolated sphere, negligible wall effects, and reviewed Reynolds-number threshold.                   | Independent worked examples, limiting behavior, and applicability boundaries.               | Pending                                       |
| SET-02 | Select drag outside the creeping-flow regime without a discontinuous or hidden rule.  | Drag correlation/iterative force balance; no correlation selected.                           | P3.3 must cite the original selected correlation; secondary summaries are not sufficient.                                                                                                                                                                               | Published $Re_p$, shape, concentration, and wall ranges; convergence criteria.                                           | Regime boundaries, independent values, convergence/non-convergence, and metamorphic checks. | Blocked on P3.3 selection                     |
| SET-03 | Account for concentrated suspension only where evidence supports it.                  | Hindered-settling relation candidate; exponent and transition are not selected.              | J. F. Richardson and W. N. Zaki, “Sedimentation and fluidisation: Part I,” _Transactions of the Institution of Chemical Engineers_ 32 (1954), 35–53 ([bibliographic record](https://www.icheme.org/knowledge-networks/publications/transactions/transactions-archive/)) | Original-source equation, concentration definition, Reynolds regime, vessel/particle scale, and later validity evidence. | Dilute limit, concentration boundaries, monotonicity, and worked examples.                  | Pending source-text verification and reviewer |
